...
import com.barberia.agendas.dto.CampoInvalidoDTO;
import com.barberia.agendas.dto.ErrorDTO;
import com.barberia.agendas.dto.ValidacionErrorDTO;
...
public class ManejadorErrores {
    ...
    public ResponseEntity<ErrorDTO> manejarAgendaBusinessException(AgendaBusinessException ex) {
        ErrorDTO response = new ErrorDTO(
                LocalDateTime.now(),
